    ...
    <div id='home' className='overflow-x-hidden'>
        ...
        <div className='h-screen flex items-center px-[4%] lg:px-[10%] relative'>
            ...
            <div>
                ...
                ></div>
                <img data-aos="fade-left" src={homeImg} className='absolute md:opacity-100 opacity-0 rounded-[5rem] aspect-square xl:w-[340px] lg:w-[290px] md:w-[250px] w-[220px] z-40 border-[5px] md:top-[14rem] lg:right-[9rem] md:right-[3rem] -right-[20rem]'/>
