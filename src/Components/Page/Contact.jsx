...
function Contact() {
    return (
        <div className='pb-[100px] -z-10'>
            <div className='relative lg:top-[8rem] top-[5rem] left-0 right-0 -z-10'>
            ...
            <div className='mt-[150px] flex lg:flex-row flex-col justify-center md:gap-[3rem] gap-[1rem] md:px-[12%] px-[4%]'>
